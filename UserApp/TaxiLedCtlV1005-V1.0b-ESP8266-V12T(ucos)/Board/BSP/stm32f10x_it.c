...
void USART1_IRQHandler(void)
{
	...
	if(USART_GetITStatus(USART1, USART_IT_RXNE) != RESET)
	{
        ...
        tData = (INT8U)(USART_ReceiveData(USART1) & 0xFF); 
        
        USART_RX_BUF[USART_RX_CNT]=tData;
        ...
        if(USART_RX_CNT >= 1000)
        {
            ...
            USART_RX_CNT = 0;
            memcpy((u8 *)&MyIapRxBuff.WriteBuff[0], (u8 *)&USART_RX_BUF[0], MyIapRxBuff.WriteSize);
...
void USART2_IRQHandler(void)
{
	...
	if(USART_GetITStatus(USART2, USART_IT_RXNE) != RESET)
	{
        ...
        tData = (INT8U)(USART_ReceiveData(USART2) & 0xFF); 
        
        USART_SendData(USART1, tData);
        Rxd2Buf[(Rx2Head++)%Rxd2BufLen] = tData;
	}
