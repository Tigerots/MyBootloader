...
#define BKP_SYSTEM_STATUS				  ((u16)0x0014)
#define BKP_DR6                           ((u16)0x0018)
#define BKP_DR7                           ((u16)0x001C)
#define BKP_USER_CARD_NO_HIGH			  ((u16)0x0018)
#define BKP_USER_CARD_NO_LOW			  ((u16)0x001C)
#define BKP_DR8                           ((u16)0x0020)
#define BKP_TOUBI_PULSE_NUMBER			  ((u16)0x0020)
